...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        #watersafe attribute in Insect class and Bee class changed as well.
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            #for bee in Place.bees:
                ...
                #insect.armor -= self.fire_damage
            for insect in self.place:
                #copy_place.append(insect)
                #   for insect in copy_place:
                if not is_ant(insect):
                    insect.armor -= self.fire_damage
